...
import PropertySlider from "../components/Omah/Home/Slider/PropertySlider";

// Chart
import ChartDoughnut from "../components/Omah/Home/Chart/DonutChart";
// Apex Chart
import loadable from "@loadable/component";
import pMinDelay from "p-min-delay";
const PieChart = loadable(() =>
  pMinDelay(import("../components/Omah/Home/Chart/PieChart"), 500)
);
const ChartTimeLine = loadable(() =>
  pMinDelay(import("../components/Omah/Home/Chart/ChartTimeline"), 500)
);
const ChartBar = loadable(() =>
  pMinDelay(import("../components/Omah/Home/Chart/ChartBar"), 500)
);
