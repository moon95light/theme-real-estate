...
import DropFile from "../../components/AppsMenu/Email/Compose/DropFile";
...
const AnCommunicationEmails = () => {
    const { t } = useTranslation();
    return (
        <Fragment>
            <div className="page-titles">
                <h4 className="page-title">{t('Emails')}</h4>
            </div>
...
export default AnCommunicationEmails;
