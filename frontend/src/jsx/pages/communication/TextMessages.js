...
import InboxMessage from "../../components/AppsMenu/Email/Inbox/InboxMessage";
import { Dropdown } from "react-bootstrap";
import { useTranslation } from 'react-i18next';

const AnCommunicationTextMessages = () => {
    ...
    return (
        <Fragment>
            <div className="page-titles">
                <h4 className="page-title">{t('Text messages')}</h4>
            </div>
...
export default AnCommunicationTextMessages;
