                            ...
                            <Table responsive>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <i className="fa fa-circle text-warn mr-1"></i>{" "}
                                                New
                                            </div>
                                            <div className="another-events">
                                        ...
                                        <td className="py-2" style={{ display: 'inline-flex' }}>
                                            <span style={{ paddingTop: '10px' }}>Antonio Torres</span><span> {drop}</span>
                                        </td>
                                    </tr>
    ...
    return (
        <Fragment>
            <div className="page-titles">
                <h4 className="page-title">  {t('All Tasks')}</h4>
...
export default AnTasksAllTasks;
